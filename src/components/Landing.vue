<template>
    <header class="sticky@md top:0 flex w:full mx:auto z-index:99999 bg:white justify-content:center bb:1|solid|rgba(0,0,0,0.1)">
        <div class="flex w:full max-w:xl align-items:center px:32">
            <a href="/" class="flex">
                <h1 class="py:16 f:30">
                    <svg class="svg-inline--fa fill:current" enable-background="new 0 0 508.992 508.992" viewBox="0 0 508.992 508.992" xmlns="http://www.w3.org/2000/svg">
                        <g>
    ...
    <main id="main">
        ...
        <div class="block-intro w:full max-w:xl mx:auto flex flex:column text:center my:60">
            ...
            <div class="headline px:20 mx:30 my:30 lh:1.4">
                ...
                <p class="my:16 mx:65@md f:22 fg:gray-40">
                    Manage or sell multiple Oxygen design sets with seamless integration into WordPress e-commerce platforms.
                </p>
            </div>
            <!-- Core Features -->
            ...
            <div class="flex flex:column align-items:center justify-content:center mb:60 mx:30@sm mx:40@md py:30 r:8 bg:gray-98">
                ...
                <div class="mt:30 text:center">
                    <a href="https://rosua.org/support-portal" target="_blank" class="text:underline">
                        tell us, we'll provide you a free license
                    </a>
                </div>
            </div>
        </div>
        ...
        <div id="features" class="block-features max-w:xl flex flex:column align-items:center my:60 mx:20 mx:30@sm mx:40@md mx:auto@xl">
            ...
            <div class="flex text:center justify-content:center">
                <p class="max-w:60%@md f:18 lh:1.5">
                    At Yabe Kokoro, we created an <strong>easy-to-use yet e-commerce ready plugin</strong> for Oxygen to empower your design sets.
                </p>
            </div>
                ...
                <div class="feature__detail my:30 flex flex:column flex-basis:37%@md align-items:flex-start justify-content:center w:full pr:3%@sm {bt:1|solid|gray-85}>:not([hidden])~:not([hidden])">
                    <div class="w:full flex flex:column align-items:flex-start">
                        ...
                        <div class="f:18 lh:1.5">
                            Yabe Kokoro provides <strong>effortless integration</strong> with the most widely used e-commerce platforms for WordPress.
                        </div>
        ...
        <div id="testimonials" class="block-testimonials max-w:xl flex flex:column my:60 mx:20 mx:30@sm mx:40@md mx:auto@xl">
            ...
            <div class="testimonials__wall w:full bg:gray-95 my:60 p:20 p:30@sm p:40@md r:8 ">
                ...
                <div class="mt:30 text:center">
                    <a href="https://wordpress.org/support/plugin/yabe-kokoro/reviews/?filter=5/#new-post" target="_blank" class="text:underline">
        ...
        <div id="pricing" class="block-pricing max-w:xl flex flex:column my:60 mx:20 mx:30@sm mx:40@md mx:auto@xl">
            ...
            <div class="flex flex:column align-items:center mb:16">
                <div class="px:16 py:6 r:8 bg:crimson-95 fg:crimson-55 b:1|solid|crimson-65 text:center font:medium ls:2 lh:1.5">
                    <i class="fa-solid fa-gift fg:crimson pr:6"></i> <span class="ls:1 font:bold">50% off</span> until <span class="ls:1 font:bold">Sept 1</span>, with code: <code class="font:extrabold bg:white">REFRESHED-50</code>
                </div>
            </div>
...
const HIGHLIGHTED_FEATURES = [
    {
        ...
        description: `Manage access to your design sets with a license system. You can create unlimited licenses and assign them to your customers.`,
    ...
    },
    {
        ...
        description: `Sell your design sets with ease. Yabe Kokoro is integrated with the most popular e-commerce plugins.`,
        image: '/assets/landing/feature-e-commerce-ready.png',
        color: 'gold',
        class: 'grid-col-span:6',
    },
    {
        title: 'Truely an Oxygen add-on',
        description: `Yabe Kokoro built only a thin layer on top of Oxygen Builder. Fully compatible with Oxygen's built-in design sets system and make it a future-proof add-on.`,
    ...
    },
    {
        ...
        description: `The license system is built on Oxygen's built-in system, WordPress REST API, and a modern JavaScript framework for an instant, responsive user experience. It has a small footprint and won't slow down your site.`,
...
const PRICING = [
    ...
    },
    {
        ...
        purchaseButton: { url: 'https://rosua.org/checkout/?edd_action=add_to_cart&download_id=1214&edd_options[price_id]=1' },
    },
    {
        duration: 'year',
        amount: 39,
...
onBeforeMount(() => {
    ...
    fetch('https://rosua.org/wp-json/rosua-edd/v1/stats/total_sites')
        .then(res => res.json())
        .then(res => {
            // search array of object with download_id = 1214 (Yabe Kokoro)
            const download = res.find(item => item.download_id === 1214);
...
onMounted(() => {
    ...
    pupRive = new Rive({
        src: 'https://cdn.jsdelivr.net/gh/orgrosua/yabe-kokoro-docs/public/assets/landing/pup.riv',
